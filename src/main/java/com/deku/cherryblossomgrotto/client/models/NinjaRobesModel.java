...
public class NinjaRobesModel extends ModArmourModel {
	public ResourceLocation texture;

	public NinjaRobesModel(ModelPart root) {
		super(root, "ninja_suit");
	}
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition rightBoot = part.addOrReplaceChild("right_leg", CubeListBuilder.create()
				.texOffs(30, 84).addBox(-3.0F, 11.0F, -3.0F, 6.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false),
			PartPose.offset(-1.9F, 12.0F, 0.0F)
		);

		PartDefinition leftBoot = part.addOrReplaceChild("left_leg", CubeListBuilder.create()
