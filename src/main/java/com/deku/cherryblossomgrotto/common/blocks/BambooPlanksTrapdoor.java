...
public class BambooPlanksTrapdoor extends TrapDoorBlock {
    public BambooPlanksTrapdoor() {
        super(Properties.of(Material.WOOD, Blocks.BAMBOO_PLANKS.defaultMaterialColor()).strength(3.0f).sound(SoundType.BAMBOO_WOOD).noOcclusion().isValidSpawn(BambooPlanksTrapdoor::never).requiredFeatures(FeatureFlags.UPDATE_1_20), SoundEvents.BAMBOO_WOOD_TRAPDOOR_CLOSE, SoundEvents.BAMBOO_WOOD_TRAPDOOR_OPEN);
    }
