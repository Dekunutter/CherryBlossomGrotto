...
public class MangrovePlanksTrapdoor extends TrapDoorBlock {
    public MangrovePlanksTrapdoor() {
        super(Properties.of(Material.WOOD, Blocks.MANGROVE_PLANKS.defaultMaterialColor()).strength( 3.0f).sound(SoundType.WOOD).noOcclusion().isValidSpawn(MangrovePlanksTrapdoor::never), SoundEvents.WOODEN_TRAPDOOR_CLOSE, SoundEvents.WOODEN_TRAPDOOR_OPEN);
    }
