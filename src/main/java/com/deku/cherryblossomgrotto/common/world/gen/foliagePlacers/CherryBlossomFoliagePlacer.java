...
public class CherryBlossomFoliagePlacer extends FoliagePlacer {
    public static final Codec<CherryBlossomFoliagePlacer> CODEC = RecordCodecBuilder.create((p_236897_0_) ->
        foliagePlacerParts(p_236897_0_).apply(p_236897_0_, CherryBlossomFoliagePlacer::new)
    );
