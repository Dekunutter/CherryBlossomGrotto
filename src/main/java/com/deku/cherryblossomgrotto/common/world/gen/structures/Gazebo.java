...
public class Gazebo extends Structure {
    public static final Codec<Gazebo> CODEC = simpleCodec(Gazebo::new);

    public static final WeightedRandomList<MobSpawnSettings.SpawnerData> GAZEBO_ENEMIES = WeightedRandomList.create();

    public Gazebo(Structure.StructureSettings structureSettings) {
    ...
    public void generatePieces(StructurePiecesBuilder pieceBuilder, Structure.GenerationContext generatorContext) {
        ...
        GazeboPieces.addPieces(generatorContext.structureTemplateManager(), position, rotation, pieceBuilder, generatorContext.random());
    }
    ...
    public StructureType<?> type() {
        return ModStructureTypeInitializer.GAZEBO.get();
    }
}
