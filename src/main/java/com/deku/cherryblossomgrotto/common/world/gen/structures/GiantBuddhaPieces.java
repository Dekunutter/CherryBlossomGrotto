...
public class GiantBuddhaPieces {
    ...
    public static void addPieces(TemplateManager templateManager, BlockPos position, Rotation rotation, List<StructurePiece> pieces, Random random) {
        pieces.add(new GiantBuddhaPieces.Piece(templateManager, GIANT_BUDDHA_COMPLETE, position, rotation, 0));
    }
    ...
    public static class Piece extends TemplateStructurePiece {
        ...
        public Piece(TemplateManager templateManager, ResourceLocation resourceLocation, BlockPos position, Rotation rotation, int offsetY) {
            super(ModStructurePieceTypes.GIANT_BUDDHA_PIECE, 0);
        ...
        public Piece(TemplateManager templateManager, CompoundNBT compoundNBT) {
            super(ModStructurePieceTypes.GIANT_BUDDHA_PIECE, compoundNBT);
        ...
        protected void handleDataMarker(String dataMarker, BlockPos position, IServerWorld world, Random random, MutableBoundingBox boundingBox) {
            if ("false_chest".equals(dataMarker)) {
                ...
                LockableLootTileEntity.setLootTable(world, random, position.below(), ModLootTables.GIANT_BUDDHA_FAKE_CHEST_LOOT_TABLE);
            } else if ("real_chest".equals(dataMarker)) {
                world.setBlock(position, Blocks.AIR.defaultBlockState(), 3);
                LockableLootTileEntity.setLootTable(world, random, position.below(), ModLootTables.GIANT_BUDDHA_REAL_CHEST_LOOT_TABLE);
            }
        }
    }
}
