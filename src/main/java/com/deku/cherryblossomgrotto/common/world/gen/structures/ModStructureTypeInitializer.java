...
public class ModStructureTypeInitializer {
    ...
    public static final RegistryObject<StructureType<?>> GIANT_BUDDHA = STRUCTURE_TYPES.register("giant_buddha", () -> convert(GiantBuddha.CODEC));
    public static final RegistryObject<StructureType<?>> TORII_GATE = STRUCTURE_TYPES.register("torii_gate", () -> convert(ToriiGate.CODEC));
