package com.deku.eastwardjourneys.common.foods;
...
public class ModFoods {
    ...
    public static final FoodProperties CONGEE = new FoodProperties.Builder().nutrition(6).saturationMod(0.6F).build();
