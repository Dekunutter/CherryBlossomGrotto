...
import com.deku.eastwardjourneys.client.renderers.NinjaRobesRenderer;
...
public class NinjaRobesItem extends ArmorItem implements GeoItem {
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);

    public NinjaRobesItem(Type type) {
        super(ModArmorMaterials.WOOL, type, new Properties().stacksTo(1));
    }
    ...
    public void initializeClient(Consumer<IClientItemExtensions> consumer) {
        consumer.accept(new IClientItemExtensions() {
            ...
            public @NotNull HumanoidModel<?> getHumanoidArmorModel(LivingEntity entity, ItemStack itemStack, EquipmentSlot armorSlot, HumanoidModel<?> defaultArmor) {
                if (renderer == null) {
                    renderer = new NinjaRobesRenderer();
                }
