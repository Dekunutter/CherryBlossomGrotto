...
import com.deku.eastwardjourneys.common.features.ModMiscOverworldFeatures;
...
public class ModMiscOverworldPlacements {
    ...
    public static void bootstrap(BootstapContext<PlacedFeature> context) {
        ...
        context.register(MOSS_LAYER, new PlacedFeature(featureGetter.getOrThrow(ModMiscOverworldFeatures.MOSS_LAYER), List.of(BiomeFilter.biome())));
